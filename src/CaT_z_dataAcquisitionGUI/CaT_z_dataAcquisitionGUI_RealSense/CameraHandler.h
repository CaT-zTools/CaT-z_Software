...
namespace facegram {
	namespace cam {
		...
		public:
			CameraHandler() {};
          virtual std::pair<std::vector<double>, std::vector<double>> captureFrames(const unsigned int frames, FrameHandler *handlerColor, FrameHandler *handlerDepth, FrameHandler *handlerRGBNotReg) = 0;
